...
CHANNEL = "AF7"           # EEG channel
FS = 256                  # Muse sample rate
WINDOW_SEC = 0.25          # sliding window in seconds (smaller = more notes)
MIDI_PORT = "EEG_MIDI 2"    # virtual port name (loopMIDI or IAC)
...
for i in range(0, len(signal) - window_size, window_size):
    ...
    time.sleep(WINDOW_SEC / 2)  # short note duration
